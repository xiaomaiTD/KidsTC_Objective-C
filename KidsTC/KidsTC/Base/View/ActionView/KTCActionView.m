...
@interface KTCActionViewBtutton : UIButton

@end

@implementation KTCActionViewBtutton
...
- (CGRect)imageRectForContentRect:(CGRect)contentRect {
    ...
    return CGRectMake((CGRectGetWidth(contentRect)-imageSize)*0.5, 6, imageSize, imageSize);
}
