...
@implementation WholesaleProductDetailTeam
...
- (void)setupCountDownValueString {
    ...
    NSDate *date = [NSDate dateWithTimeIntervalSinceNow:_remainTime];
    ...
    _countDownValueString = [NSString stringWithFormat:@"%@%@",@"剩余：",time];
    _remainTime--;
}
