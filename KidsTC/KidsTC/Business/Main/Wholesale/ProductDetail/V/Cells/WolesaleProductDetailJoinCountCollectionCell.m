//
//  WolesaleProductDetailJoinCountCollectionCell.m
//  KidsTC
//
...
@interface WolesaleProductDetailJoinCountCollectionCell ()
@property (weak, nonatomic) IBOutlet UILabel *titleL;

@end

@implementation WolesaleProductDetailJoinCountCollectionCell
