//
//  WolesaleProductDetailV2BannersCell.m
//  KidsTC
//
...
#import "YYKit.h"
static NSString *const ID = @"WolesaleProductDetailV2BannersCollectionCell";
static int const kWolesaleProductDetailV2BannersCellMaxSections = 11;

@interface WolesaleProductDetailV2BannersCell ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation WolesaleProductDetailV2BannersCell

- (void)awakeFromNib {
    [super awakeFromNib];
    
    [self.collectionView registerNib:[UINib nibWithNibName:@"WolesaleProductDetailV2BannersCollectionCell" bundle:nil] forCellWithReuseIdentifier:ID];
...
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView *)collectionView {
    return _narrowImg.count>1?kWolesaleProductDetailV2BannersCellMaxSections:1;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    WolesaleProductDetailV2BannersCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
...
- (void)nextPage
{
    ...
    if (nextItem<count && nextSection<kWolesaleProductDetailV2BannersCellMaxSections) {
...
- (NSIndexPath *)resetIndexPath
{
    ...
    // 马上显示回最中间那组的数据
    NSIndexPath *currentIndexPathReset = [NSIndexPath indexPathForItem:currentIndexPath.item inSection:kWolesaleProductDetailV2BannersCellMaxSections/2];
