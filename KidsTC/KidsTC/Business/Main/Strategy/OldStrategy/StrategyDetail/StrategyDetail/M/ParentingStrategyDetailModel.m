...
//        self.mainImageUrl = [NSURL URLWithString:[infoDic objectForKey:@"image"]];
        ...
        CGFloat imageRatio = [infoDic[@"imageRatio"] floatValue];
        if (imageRatio<=0) imageRatio = 0.618;
        self.mainImageRatio = imageRatio;
...
//        contentHeight = [ToolBox heightForLabelWithWidth:SCREEN_WIDTH - 80 LineBreakMode:NSLineBreakByCharWrapping Font:[UIFont systemFontOfSize:14] topGap:10 bottomGap:10 andText:self.strategyDescription];
        contentHeight = [ToolBox heightForAttributeLabelWithWidth:SCREEN_WIDTH - 80 LineBreakMode:NSLineBreakByCharWrapping Font:[UIFont systemFontOfSize:14] topGap:10 bottomGap:10 maxLine:0 andText:self.strategyDescription];
    }
...
//        self.imageUrl = [NSURL URLWithString:[data objectForKey:@"image"]];
        ...
        CLLocationCoordinate2D coordinate = [ToolBox coordinateFromString:[data objectForKey:@"mapAddress"]];
        ...
        self.relatedInfoModel = [SegueModel modelWithDestination:dest paramRawData:[data objectForKey:@"params"]]; 
        self.relatedInfoTitle = [data objectForKey:@"linkTitle"];
        self.commentCount = [[data objectForKey:@"commentCount"] integerValue];
        CGFloat ratio = [data[@"imageRatio"] floatValue];
...
//    height += [ToolBox heightForLabelWithWidth:cellWidth - 20 LineBreakMode:NSLineBreakByCharWrapping Font:[UIFont systemFontOfSize:15] topGap:10 bottomGap:10 andText:self.cellContentString]; //内容
    height += [ToolBox heightForAttributeLabelWithWidth:cellWidth - 20 LineBreakMode:NSLineBreakByCharWrapping Font:[UIFont systemFontOfSize:15] topGap:10 bottomGap:20 maxLine:0 andText:self.cellContentString];
