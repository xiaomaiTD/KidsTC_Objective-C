//
//  RadishProductDetailBannerCell.m
//  KidsTC
//
...
#import "YYKit.h"
static NSString *const ID = @"RadishProductDetailBannerCollectionViewCell";
static int const kRadishProductDetailBannerCellMaxSections = 11;

@interface RadishProductDetailBannerCell ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation RadishProductDetailBannerCell

- (void)awakeFromNib {
    [super awakeFromNib];

    [self.collectionView registerNib:[UINib nibWithNibName:@"RadishProductDetailBannerCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:ID];
...
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView *)collectionView {
    return _narrowImg.count>1?kRadishProductDetailBannerCellMaxSections:1;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    RadishProductDetailBannerCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
...
- (void)nextPage
{
    ...
    if (nextItem<count && nextSection<kRadishProductDetailBannerCellMaxSections) {
...
- (NSIndexPath *)resetIndexPath
{
    ...
    // 马上显示回最中间那组的数据
    NSIndexPath *currentIndexPathReset = [NSIndexPath indexPathForItem:currentIndexPath.item inSection:kRadishProductDetailBannerCellMaxSections/2];
