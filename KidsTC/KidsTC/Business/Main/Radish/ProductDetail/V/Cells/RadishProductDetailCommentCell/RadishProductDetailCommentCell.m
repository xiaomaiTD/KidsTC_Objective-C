//
//  RadishProductDetailCommentCell.m
//  KidsTC
//
...
#import "RadishProductDetailCommentCellCollectionViewCell.h"

static NSString *const ID = @"RadishProductDetailCommentCellCollectionViewCell";

@interface RadishProductDetailCommentCell ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@property (nonatomic, strong) RadishProductDetailCommentItem *comment;
@end

@implementation RadishProductDetailCommentCell
...
- (void)awakeFromNib {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"RadishProductDetailCommentCellCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:ID];
...
- (void)setData:(RadishProductDetailData *)data {
    ...
    if (_index<data.commentList.count) {
        RadishProductDetailCommentItem *comment = data.commentList[_index];
...
- (void)tapAction:(UITapGestureRecognizer *)tapGR {
    if ([self.delegate respondsToSelector:@selector(radishProductDetailBaseCell:actionType:value:)]) {
        [self.delegate radishProductDetailBaseCell:self actionType:RadishProductDetailBaseCellActionTypeComment value:@(_index)];
    }
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    RadishProductDetailCommentCellCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
