//
//  RadishProductDetailCouponCell.m
//  KidsTC
//
...
#import "RadishProductDetailCouponCell.h"

@interface RadishProductDetailCouponCell ()
@property (weak, nonatomic) IBOutlet UILabel *tipL;
@property (weak, nonatomic) IBOutlet UIImageView *arrowImgView;
@property (nonatomic, strong) NSMutableArray<UILabel *> *labels;
@end

@implementation RadishProductDetailCouponCell
...
- (void)tapAction:(UITapGestureRecognizer *)tapGR {
    if ([self.delegate respondsToSelector:@selector(radishProductDetailBaseCell:actionType:value:)]) {
        [self.delegate radishProductDetailBaseCell:self actionType:RadishProductDetailBaseCellActionTypeCoupon value:@(self.data.canProvideCoupon)];
    }
}
