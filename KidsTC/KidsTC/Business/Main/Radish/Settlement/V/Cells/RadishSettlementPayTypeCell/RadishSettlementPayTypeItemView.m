//
//  RadishSettlementPayTypeItemView.m
//  KidsTC
//
...
@interface RadishSettlementPayTypeItemView ()
...
@implementation RadishSettlementPayTypeItemView
...
- (IBAction)action:(UIButton *)sender {
    if ([self.delegate respondsToSelector:@selector(didClickRadishSettlementPayTypeItemView:)]) {
        [self.delegate didClickRadishSettlementPayTypeItemView:self];
    }
}
