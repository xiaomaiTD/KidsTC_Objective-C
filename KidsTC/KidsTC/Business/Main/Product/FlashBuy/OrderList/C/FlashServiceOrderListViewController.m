...
- (void)flashServiceOrderListCell:(FlashServiceOrderListCell *)cell actionType:(FlashServiceOrderListCellActionType)type {
    switch (type) {
        ...
        {
            FlashBuyProductDetailStatus status = cell.item.status;
            switch (status) {
                    /**
                     *  等待预付 | 开团成功（已预付，待付尾款）跳转支付页
                     */
                case FlashBuyProductDetailStatusWaitPrePaid:
                case FlashBuyProductDetailStatusFlashSuccessWaitPay:
                {
                     ...
                     */
                case FlashBuyProductDetailStatusFlashSuccessUnPay:
                {
                     ...
                     *  已购买，去评价
                     */
                case FlashBuyProductDetailStatusWaitEvalute:
                {
