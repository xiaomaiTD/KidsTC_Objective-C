//
//  NormalProductDetailSecondKillCell.m
//  KidsTC
//
...
@interface NormalProductDetailSecondKillCell ()
...
@implementation NormalProductDetailSecondKillCell
...
- (void)countDown {
    NormalProductDetailCountDown *countDown = self.data.countDown;
    ...
    if ([str isNotNull]) {
        ...
        if (countDown.showCountDown && !countDown.countDownOver) {
            ...
            if ([self.delegate respondsToSelector:@selector(normalProductDetailBaseCell:actionType:value:)]) {
                [self.delegate normalProductDetailBaseCell:self actionType:NormalProductDetailBaseCellActionTypeCountDownOver value:self.data];
            }
        }
    }
}
