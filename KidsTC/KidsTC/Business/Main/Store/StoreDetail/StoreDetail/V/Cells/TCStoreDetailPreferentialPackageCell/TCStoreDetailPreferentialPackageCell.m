//
//  TCStoreDetailPreferentialPackageCell.m
//  KidsTC
//
...
@interface TCStoreDetailPreferentialPackageCell ()
...
@implementation TCStoreDetailPreferentialPackageCell
...
- (void)setData:(TCStoreDetailData *)data {
    ...
    NSArray<TCStoreDetailProductPackageItem *> *products = data.productPackage.products;
...
- (IBAction)action:(UIButton *)sender {
    NSArray<TCStoreDetailProductPackageItem *> *products = self.data.productPackage.products;
