...
- (instancetype)initWithRawData:(NSDictionary *)data {
    ...
    if (self) {
        ...
        NSString *imageUrlStr = [data objectForKey:@"imgUrl"];
        if(![imageUrlStr isKindOfClass:[NSNull class]] && imageUrlStr && imageUrlStr.length>0)self.imageUrl = [NSURL URLWithString:imageUrlStr];
        ...
        //location
        CLLocationCoordinate2D coord = [ToolBox coordinateFromString:[data objectForKey:@"mapAddress"]];
