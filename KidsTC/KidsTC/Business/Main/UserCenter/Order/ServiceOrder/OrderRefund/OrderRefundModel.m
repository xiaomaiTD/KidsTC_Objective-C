...
- (CGFloat)cellHeight {
    CGFloat height = [ToolBox heightForLabelWithWidth:SCREEN_WIDTH - 85 LineBreakMode:NSLineBreakByCharWrapping Font:[UIFont systemFontOfSize:13] topGap:10 bottomGap:10 andText:[self codeString]];
    height += 52;
    height += [ToolBox heightForLabelWithWidth:SCREEN_WIDTH - 85 LineBreakMode:NSLineBreakByCharWrapping Font:[UIFont systemFontOfSize:13] topGap:0 bottomGap:10 andText:self.flowDescription];
