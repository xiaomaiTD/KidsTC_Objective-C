...
- (instancetype)initWithRawData:(NSDictionary *)data {
    ...
    if (self) {
        ...
        self.imageUrl = [NSURL URLWithString:[NSString stringWithFormat:@"%@",[data objectForKey:@"imgUrl"]]];
        ...
        self.orderKind = [data[@"orderKind"] integerValue];
        self.commentNo = [NSString stringWithFormat:@"%@",data[@"commentNo"]];
        self.commentRelationType = [data[@"commentRelationType"] integerValue];
    }
    return self;
}
