//
//  ProductOrderNormalDetailData.m
//  KidsTC
//
...
+ (NSDictionary *)modelContainerPropertyGenericClass{
    return @{@"remarks":[ProductOrderNormalDetailRemark class],
             @"refunds":[ProductOrderNormalDetailRefund class],
             @"orderUsedConsumeCode":[ProductOrderNormalDetailConsumeCode class],
...
- (void)setupRemarks {
    if (self.remarks.count>0) {
        ...
        [self.remarks enumerateObjectsUsingBlock:^(ProductOrderNormalDetailRemark * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
...
- (void)setupBtns {
    ...
    for (int i = 1; i<=4; i++) {
        ...
        if (index>=0) {
            ...
            ProductOrderNormalDetailBtnType btnType = obj.integerValue;
            ProductOrderNormalDetailBtn *btn = [ProductOrderNormalDetailBtn btnWithType:btnType isHighLight:btnType == _defaultBtn];
