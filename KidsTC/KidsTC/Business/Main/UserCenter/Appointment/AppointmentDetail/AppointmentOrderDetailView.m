...
- (id)awakeAfterUsingCoder:(NSCoder *)aDecoder
{
    ...
    {
        bLoad = YES;
        AppointmentOrderDetailView *view = [ToolBox getObjectFromNibWithView:self];
        [view buildSubviews];
        return view;
    }
    bLoad = NO;
...
- (void)buildSubviews {
    ...
    [self.commentButton setBackgroundColor:COLOR_PINK forState:UIControlStateNormal];
    [self.commentButton setBackgroundColor:COLOR_PINK forState:UIControlStateSelected];
    
    self.cancelAppointmentButton.layer.borderWidth = LINE_H;
    self.cancelAppointmentButton.layer.borderColor = [UIColor whiteColor].CGColor;
...
//    [self.getCodeButton setBackgroundColor:COLOR_PINK forState:UIControlStateNormal];
//    [self.getCodeButton setBackgroundColor:COLOR_PINK forState:UIControlStateSelected];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    switch (indexPath.section) {
        case 0:{
            [self.storeImageView sd_setImageWithURL:self.orderModel.imageUrl placeholderImage:PLACEHOLDERIMAGE_SMALL];
            ...
            [self.storeInfoCell.contentView setBackgroundColor:COLOR_BG_CEll];
        ...
        case 1:{
            ...
            [self.orderInfoCell.contentView setBackgroundColor:COLOR_BG_CEll];
