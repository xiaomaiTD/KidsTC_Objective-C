...
- (void)awakeFromNib {
    ...
    [self.headerBGView setBackgroundColor:[UIColor whiteColor]];
    [self drawTriangleForHeader];
    [self.separaterView setBackgroundColor:BorderColor];
    [ToolBox resetLineView:self.separaterView withLayoutAttribute:NSLayoutAttributeHeight];
...
- (void)drawTriangleForHeader {
    ...
    maskBorderLayer.fillColor = COLOR_BG_CEll.CGColor;
    maskBorderLayer.strokeColor = BorderColor.CGColor;//边框颜色
    maskBorderLayer.lineWidth = LINE_H; //边框宽度
