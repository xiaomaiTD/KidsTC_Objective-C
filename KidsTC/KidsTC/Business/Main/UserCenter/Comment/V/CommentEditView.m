...
- (id)awakeAfterUsingCoder:(NSCoder *)aDecoder
{
    ...
    {
        bLoad = YES;
        CommentEditView *view = [ToolBox getObjectFromNibWithView:self];
        [view buildSubviews];
        return view;
    }
    bLoad = NO;
    ...
    switch (indexPath.section) {
        case 0:{
            ...
            if ([self.commentModel.commentText length] > 0) {
                ...
                self.commentLengthLabel.text = [NSString stringWithFormat:@"%zd",[self.commentModel.commentText length]];
