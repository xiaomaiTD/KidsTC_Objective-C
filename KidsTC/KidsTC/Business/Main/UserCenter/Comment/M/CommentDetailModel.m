...
#import "ToolBox.h"
//#import "ParentingStrategyDetailCellModel.h"
    ...
    if (headerModel) {
        ...
        switch (self.modelSource) {
            ...
            case CommentDetailViewSourceServiceOrStore:
            {
                ...
                CGFloat labelHeight = [ToolBox heightForLabelWithWidth:SCREEN_WIDTH - 20 LineBreakMode:NSLineBreakByCharWrapping Font:[UIFont systemFontOfSize:13] topGap:10 bottomGap:10 andText:comments];
