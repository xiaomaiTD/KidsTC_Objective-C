...
- (CGFloat)cellHeight {
    CGFloat height = [ToolBox heightForLabelWithWidth:SCREEN_WIDTH - 10 LineBreakMode:NSLineBreakByCharWrapping Font:[UIFont systemFontOfSize:16] topGap:10 bottomGap:10 maxLine:0 andText:self.replyContent];
    height += 40;
    if (height < 80) {
        height = 80;
    }
