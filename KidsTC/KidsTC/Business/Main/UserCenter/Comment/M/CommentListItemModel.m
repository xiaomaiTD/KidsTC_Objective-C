...
- (CGFloat)cellHeight {
    ...
    //Label
    CGFloat labelHeight = [ToolBox heightForLabelWithWidth:SCREEN_WIDTH - 20 LineBreakMode:NSLineBreakByCharWrapping Font:[UIFont systemFontOfSize:13] topGap:10 bottomGap:10 andText:self.comments];
    //phots
...
- (CGFloat)storeDetailCellHeight {
    CGFloat height = 100;
    //Label
    CGFloat labelHeight = [ToolBox heightForLabelWithWidth:SCREEN_WIDTH - 80 LineBreakMode:NSLineBreakByCharWrapping Font:[UIFont systemFontOfSize:13] topGap:10 bottomGap:10 andText:self.comments];
    //phots
    NSUInteger pictureCount = [self.thumbnailPhotoUrlStringsArray count];
    CGFloat row = 0;
    NSUInteger oneLineCount = 4;
