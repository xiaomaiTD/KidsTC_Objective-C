...
NSString *const kStoreCellIdentifier = @"StoreListViewCell";
NSString *const kCommentCellIdentifier = @"CommentListViewCell";
...
- (id)awakeAfterUsingCoder:(NSCoder *)aDecoder
{
    ...
    {
        bLoad = YES;
        ServiceDetailMoreInfoView *view = [ToolBox getObjectFromNibWithView:self];
        [view buildSubviews];
        return view;
    }
    bLoad = NO;
    ...
    switch (viewTag) {
        ...
        case ServiceDetailMoreInfoViewTagStore:
        {
            ...
            if ([self.storeListModels count] == 0) {
                self.tableView.backgroundView = [[KTCEmptyDataView alloc] initWithFrame:CGRectMake(0, 0, self.standardViewSize.width, self.standardViewSize.height) image:nil description:@"暂无门店信息~"];
            } else {
                self.tableView.backgroundView = nil;
            }
        }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (self.viewTag) {
        case ServiceDetailMoreInfoViewTagStore:
        {
            cell = [tableView dequeueReusableCellWithIdentifier:kStoreCellIdentifier];
            if (self.storeListModels.count>indexPath.row) {
        ...
        case ServiceDetailMoreInfoViewTagComment:
        {
            ...
            if (self.commentListModels.count>indexPath.row) {
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    if ([self.commentListModels count] > 0 && self.viewTag == ServiceDetailMoreInfoViewTagComment) {
        ...
        [button setBackgroundColor:COLOR_BG_CEll];
        ...
        button.layer.borderWidth = LINE_H;
