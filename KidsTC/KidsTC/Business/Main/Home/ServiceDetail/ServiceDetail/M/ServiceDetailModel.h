...
@property (nonatomic, strong) ProductStandardsItem *currentProductStandardsItem;
@property (nonatomic, assign) int currentProductStandardsItemIndex;
...
@interface ProductStandardsItem : NSObject
