//
//  FlashAdvanceSettlementServiceInfoCell.m
//  KidsTC
//
...
@interface FlashAdvanceSettlementServiceInfoCell ()
...
@implementation FlashAdvanceSettlementServiceInfoCell
...
- (void)setData:(FlashSettlementData *)data{
    ...
    self.priceLabel.text = [NSString stringWithFormat:@"预付款：¥%0.1f",data.price];
}
