...
#define cellIdentifier @"FlashDetailAutoRollViewCell"
#define AutoRollViewMaxSections 101

@interface FlashDetailAutoRollView()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation FlashDetailAutoRollView
...
-(instancetype)initWithFrame:(CGRect)frame items:(NSArray *)items delegate:(id<FlashDetailAutoRollViewDelegate>)delegate{
    ...
    if (self) {
        ...
        [self.collectionView registerClass:[FlashDetailAutoRollViewCell class] forCellWithReuseIdentifier:cellIdentifier];
        
        
        self.pageContol=[[UIPageControl alloc]initWithFrame:CGRectMake(0, CGRectGetHeight(self.bounds)-30, CGRectGetWidth(self.bounds), 30)];
...
{
    FlashDetailAutoRollViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath];
