...
- (void)setupSections {
    ...
    enrollInfo.isBabyName = YES;
    enrollInfo.isBabyBirthday = YES;
    enrollInfo.isBabySex = YES;
    enrollInfo.isHouseholdName = YES;
    enrollInfo.isBabyAge = YES;
    enrollInfo.isUserPhone = YES;
    enrollInfo.isUserAddress = YES;
