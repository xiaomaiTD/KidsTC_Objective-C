...
@interface TCHomeViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UITextFieldDelegate,StrategyToolBarDelegate,TCHomeMainCollectionCellDelegate>
