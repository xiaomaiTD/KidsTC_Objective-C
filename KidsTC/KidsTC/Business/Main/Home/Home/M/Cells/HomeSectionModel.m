...
//    }
    ...
    switch (contentType) {
        ...
        case HomeContentCellTypeTwinklingElf:
        {
            ...
            HomeTwinklingElfCellModel *contentModel = (HomeTwinklingElfCellModel *)_contentModel;
            if (data[@"bgImgUrl"]) {
                contentModel.bgImgUrl = data[@"bgImgUrl"];
            }
            _contentModel = contentModel;
        }
            break;
        ...
        case HomeContentCellTypeTwoColumn:
        {
            ...
            HomeTwoColumnCellModel *contentModel = (HomeTwoColumnCellModel *)_contentModel;
            if (data[@"centerSeparation"]) {
                contentModel.centerSeparation = [data[@"centerSeparation"] floatValue];
            }
            if (data[@"bottomSeparation"]) {
                contentModel.bottomSeparation = [data[@"bottomSeparation"] floatValue];
            }
            _contentModel = contentModel;
