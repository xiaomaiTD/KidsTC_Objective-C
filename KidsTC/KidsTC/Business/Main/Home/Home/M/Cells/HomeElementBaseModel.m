...
- (void)parseHomeData:(NSDictionary *)data {
    ...
    //跳转目的地
    SegueDestination segueDestination = (SegueDestination)[data[@"linkType"] integerValue];
    
    self.segueModel = [SegueModel modelWithDestination:segueDestination paramRawData:[data objectForKey:@"params"]];
}
