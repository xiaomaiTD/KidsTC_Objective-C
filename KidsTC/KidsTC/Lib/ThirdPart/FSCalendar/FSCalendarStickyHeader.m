...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        view.backgroundColor = [UIColor colorWithRed:0.969 green:0.969 blue:0.969 alpha:1];
        self.contentView = view;
        
        label = [[UILabel alloc] initWithFrame:CGRectZero];
        label.textAlignment = NSTextAlignmentCenter;
        label.numberOfLines = 0;
        label.backgroundColor = [UIColor colorWithRed:0.882 green:0.902 blue:0.922 alpha:1];
...
- (void)layoutSubviews
{
    ...
    if (_needsAdjustingViewFrame) {
        ...
        CGFloat weekdayMargin = 0;//weekdayHeight * 0.1;
