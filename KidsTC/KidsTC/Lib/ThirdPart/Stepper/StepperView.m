...
//    [_subBtn setImage:[UIImage imageNamed:@"stepper_sub_press"] forState:UIControlStateSelected];
...
//    [_addBtn setImage:[UIImage imageNamed:@"stepper_add_press"] forState:UIControlStateSelected];
//    [_addBtn setImage:[UIImage imageNamed:@"stepper_add_disable"] forState:UIControlStateDisabled];
    ...
    [_subBtn.layer setBorderWidth:LINE_H];
...
//    [_inputField.layer setBorderWidth:LINE_H];
...
//    [_inputField setTextColor:[UIColor colorWithRed:1.0 green:0.47 blue:0.0 alpha:1]];
    ...
    [_addBtn.layer setBorderWidth:LINE_H];
