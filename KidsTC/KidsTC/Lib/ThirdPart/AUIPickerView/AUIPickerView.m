...
- (id)awakeAfterUsingCoder:(NSCoder *)aDecoder
{
    ...
    {
        bLoad = YES;
        AUIPickerView *view = [ToolBox getObjectFromNibWithView:self];
        [view buildSubviews];
        return view;
    }
    bLoad = NO;
...
- (void)buildSubviews {
    ...
    [self.cancelButton setTitleColor:COLOR_PINK forState:UIControlStateNormal];
    [self.cancelButton setTitleColor:COLOR_PINK forState:UIControlStateSelected];
    ...
    [self.confirmButton setTitleColor:COLOR_PINK forState:UIControlStateNormal];
    [self.confirmButton setTitleColor:COLOR_PINK forState:UIControlStateSelected];
