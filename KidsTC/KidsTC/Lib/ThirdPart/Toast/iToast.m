...
- (void)realShow
{
    ...
    CGSize textSize = [_text boundingRectWithSize:CGSizeMake(screen_w/2, 999) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:font} context:nil].size;
    ...
    if (_title){
        ...
        CGFloat screen_w = [UIScreen mainScreen].bounds.size.width;
        CGSize titleTextSize = [_title boundingRectWithSize:CGSizeMake(screen_w/2, 999) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:titleFont} context:nil].size;
